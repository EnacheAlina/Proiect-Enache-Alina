...
public class CartManagementTest {
    ...
    @Test
    public void when_user_navigates_to_cart_page_empty_cart_page_is_displayed() {
        header.clickOnTheCartIcon();
        assertEquals (cartPage.getEmptyCartPage(), "How about adding some products in your cart?");
    }
    @Test
    public void when_user_adds_one_product_to_cart_page_empty_cart_message_is_not_shown() {
    ...
    @Test
    public void user_can_increment_the_amount_of_a_product_Cart_Page() {
            Product product = new Product("9");
            product.clickOnTheProductCartIcon();
            header.clickOnTheCartIcon();
    ...
    @Test
    public void user_can_reduce_the_amount_of_a_product_Cart_Page() {
        Product product = new Product("9");
        product.clickOnTheProductCartIcon();
        product.clickOnTheProductCartIcon();
        header.clickOnTheCartIcon();
